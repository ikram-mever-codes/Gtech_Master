...
export const AuftragPreviewModal: React.FC<AuftragPreviewModalProps> = ({
  ...
  const lineItemsSubtotal = visibleLineItems.reduce(
    (acc: number, li: any) => acc + getLineItemTotal(li),
    0,
  );
  ...
  const displayTotal =
    subtotalForDisplay - (order.discount_amount || 0) + vatTaxSum;
              ...
              <Field
                ...
                value={
                  order.real_delivery_date
                    ? formatDate(order.real_delivery_date)
                    : ""
                }
              >
                <input
            ...
            <div className="max-w-sm ml-auto w-full space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {formatCurrency(subtotalForDisplay, order?.currency || "EUR")}
                </span>
              </div>
