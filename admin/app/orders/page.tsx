...
import { createSupplierOrder, getAllSupplierOrders, deleteSupplierOrder, type SupplierOrder } from "@/api/supplier_orders";
...
const OrderPage = () => {
  ...
  const fetchSupplierOrders = useCallback(async () => {
    try {
      ...
      const res: any = await getAllSupplierOrders({ search: supplierOrderSearch });
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-[70]">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 border border-gray-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-900">Create Supplier Order</h3>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-3 mb-5 space-y-1 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-800">{pendingNsoGroup.supplier_name}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500">Items</span>
                <span className="font-semibold text-gray-800">{pendingNsoGroup.count} item(s)</span>
              </div>
              <div className="flex justify-between">
