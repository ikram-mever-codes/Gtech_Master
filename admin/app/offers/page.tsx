...
const OffersPage: React.FC = () => {
  ...
  const calculateDaysUntilExpiry = (validUntil: Date | string) => {
                              ...
                              <div className="flex items-center gap-1 text-xs">
                                ...
                                {/* <span
                                  className={`px-1 rounded ${
                                    getDaysUntilExpiry(offer.validUntil) <= 7
                                      ? "bg-red-100 text-red-800"
                                      : getDaysUntilExpiry(offer.validUntil) <=
                                        30
                                      ? "bg-yellow-100 text-yellow-800"
                                      : "bg-green-100 text-green-800"
                                  }`}
                                >
                                  {getDaysUntilExpiry(offer.validUntil)}d
                                </span> */}
                              </div>
                            )}
                          </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Set quantity-based prices for each item
                  </p>
                </div>
                <div className="flex gap-2">
                  <button
                  ...
                  .map((item: any) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="text-right">
                          <div className="text-sm text-gray-600">
                            Base Quantity: {item.baseQuantity || "1"}
                          </div>
                      ...
                      <div className="space-y-3">
                                ...
                                addQuantityPrice(item.id, {
                                  ...
                                  const updatedItems =
                                    selectedOffer.lineItems.map((li: any) =>
                                      li.id === item.id ? updatedItem.data : li
                                    );
                                  setSelectedOffer({
                                    ...selectedOffer,
                        ...
                        {item.quantityPrices?.length > 0 ? (
                          ...
                          <div className="text-center py-4 text-gray-500">
                            No quantity-based prices set. Add your first price
                            level.
                          </div>
                        )}
                      </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Paste tabular data from Excel or Google Sheets
                  </p>
                </div>
                <button
                ...
                <div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg text-sm text-blue-800">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                      ...
                      <li>Format: Position, Quantity, Price</li>
                      <li>Example: "1, 1000, 4.50" or "1\t1000\t4.50"</li>
                    </ul>
                    <p className="mt-3">
