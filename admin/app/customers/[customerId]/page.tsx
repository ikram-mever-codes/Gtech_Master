...
// Custom Section component for cleaner code organization
...
// Info Item component for displaying individual fields
const InfoItem = ({
  icon,
  label,
  value,
    ...
    >
      ...
      {currentTab === 1 && (
        <Box>
          <Section
            ...
            icon={<History size={20} className="text-[#8CC21B]" />}
            action={
      ...
      {currentTab === 2 && (
        <Box>
          <Grid container spacing={3} sx={{ mb: 4 }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <StatCard
                icon={<Users />}
                title="User Status"
                value={customer.isEmailVerified ? "Active" : "Pending"}
                color={
          ...
          <Section
            title="Order History"
            icon={<BarChart2 size={20} className="text-[#8CC21B]" />}
          >
            <Box
              sx={{
                height: 300,
            ...
            >
              <Typography color="text.secondary">
                Order history chart will be displayed here
              </Typography>
            </Box>
          </Section>
          ...
          <Section
            ...
            icon={<DollarSign size={20} className="text-[#8CC21B]" />}
          >
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                <Box
                ...
                >
                  ...
                  >
                    <Typography color="text.secondary">
                      Popular products chart will be displayed here
                    </Typography>
                  </Box>
                </Box>
              </Grid>
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  >
                    <Typography color="text.secondary">
                      Seasonal trends chart will be displayed here
                    </Typography>
                  </Box>
                </Box>
              </Grid>
