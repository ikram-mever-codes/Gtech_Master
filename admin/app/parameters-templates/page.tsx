          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#8CC21B]/10 flex items-center justify-center text-[#8CC21B]">
                  <Palette className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 text-base">Colours</h3>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="space-y-2.5 pt-1">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5 max-h-[220px] overflow-y-auto pr-1">
                {colours.map((item, idx) => (
                  <div
                    key={item.id || idx}
                    className="p-2.5 rounded-xl border border-gray-200 bg-gray-50/60 flex items-center justify-between gap-2"
                  >
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      <input
                        ...
                        value={item.hex}
                        onChange={(e) => handleColourItemChange(idx, "hex", e.target.value)}
                        className="w-16 px-1.5 py-0.5 text-[11px] border border-gray-200 rounded-md font-mono bg-white uppercase text-center"
                      />
                      {colours.length > 1 && (
                        <button
                          type="button"
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-5">
              <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg">Document Template</h3>
                  </div>
                </div>
              </div>
