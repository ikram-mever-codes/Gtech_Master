      ...
      <div className="min-h-screen bg-white shadow-xl rounded-lg p-6">
            ...
            <div className="flex justify-between items-center mb-4">
              <div>
                <PageHeader
                  ...
                  icon={
                    activeTab === "inquiries" ? MessagesSquare : ClipboardList
                  }
                />
              </div>
                ...
                <div className="px-4 py-3 bg-gray-50/50 border-t border-gray-200/50 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() =>
                        setInquiryCurrentPage(
                          Math.max(1, inquiryCurrentPage - 1),
                        )
                      }
                    ...
                    <div className="flex items-center gap-1">
                      {[...Array(Math.min(5, inquiryTotalPages))].map(
                        (_, i) => {
                          const pageNum = i + 1;
                          return (
                            <button
              ...
              {requestTotalPages > 1 && (
                <div className="px-4 py-3 bg-gray-50/50 border-t border-gray-200/50 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() =>
                        setRequestCurrentPage(
                          Math.max(1, requestCurrentPage - 1),
                        )
                      }
                    ...
                    <div className="flex items-center gap-1">
                      {[...Array(Math.min(5, requestTotalPages))].map(
                        (_, i) => {
                          const pageNum = i + 1;
                          return (
                            <button
        ...
        {showCreateModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div
              className={`backdrop-blur-md rounded-2xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto transition-colors duration-300 ${inquiryFormData.isAssembly ? "bg-red-50/95 border border-red-200" : "bg-white/95"}`}
            >
              <div className="p-6">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="col-span-2">
                        <div
                          className={`flex items-center gap-2 p-2 border rounded-lg transition-colors duration-200 ${inquiryFormData.isAssembly ? "border-red-300 bg-red-100" : "border-gray-300/80 bg-white/70 backdrop-blur-sm"}`}
                        >
                          <input
                            type="checkbox"
                            id="isAssembly"
                            ...
                            <input
                              ...
                              onKeyDown={(e) => {
                                if (e.key === "Enter" || e.key === ",") {
                                  ...
                                  if (
                                    value &&
                                    !inquiryFormData.painPoints?.includes(value)
                                  ) {
                                    setInquiryFormData({
                                      ...inquiryFormData,
                                      painPoints: [
                                        ...(inquiryFormData.painPoints || []),
                                        value,
                                      ],
                                    });
                    ...
                    <div className="space-y-2">
                      {inquiryRequests.map((request, index) => (
                        ...
                        >
                          ...
                          {expandedRequestIndex === index && (
                            <div
                              className={`p-3 transition-colors duration-300 ${inquiryFormData.isAssembly ? "bg-red-50/60" : "bg-white"}`}
                            >
                              <div className="grid grid-cols-2 gap-2">
                                <div className="flex gap-2">
                                    ...
                                    <div className="min-h-[60px] p-1 border border-gray-300/80 bg-white/70 backdrop-blur-sm rounded focus-within:ring-2 focus-within:ring-gray-500/50 transition-all">
                                      <div className="flex flex-wrap gap-1 mb-1">
                                        {request.painPoints?.map((tag, i) => (
                                          <span
                                            key={i}
                                            className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-gray-100 text-gray-800 border border-gray-200"
                                          >
                                            {tag}
                                            <button
                                              type="button"
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      setRequestItemFormData({
                                        ...requestItemFormData,
                                        painPoints:
                                          requestItemFormData.painPoints?.filter(
                                            (_, idx) => idx !== i,
                                          ),
                                      })
                                    }
                            ...
                            <input
                              ...
                              onKeyDown={(e) => {
                                if (e.key === "Enter" || e.key === ",") {
                                  ...
                                  if (
                                    value &&
                                    !requestItemFormData.painPoints?.includes(
                                      value,
                                    )
                                  ) {
                                    setRequestItemFormData({
                                      ...requestItemFormData,
                                      painPoints: [
                                        ...(requestItemFormData.painPoints ||
                                          []),
                                        value,
                                      ],
                                    });
                  ...
                  {conversionType === "request" && conversionRequestData && (
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <span className="ml-2 font-medium">
                          {
                            conversionRequestData.business?.customer
                              ?.companyName
                          }
                        </span>
                      </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-sm text-blue-700">
                        ...
                        <ul className="mt-1 space-y-1 list-disc list-inside">
                          <li>
                            TARIC code and EAN will be automatically generated
                            if not provided
                          </li>
                          <li>Parent and category fields will be left null</li>
                          <li>
                            For assembly inquiries, name, quantity, and image
                            will be used directly from the inquiry
                          </li>
                          <li>
