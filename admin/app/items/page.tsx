...
type TabType = "items" | "parents" | "warehouse" | "tarics" | "suppliers" | "new_items";
...
const ItemsManagementPage: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      switch (activeTab) {
        ...
        case "new_items":
          const newItemsResponse: any = await getNewItems({
            page: pagination.page,
            limit: pagination.limit,
            search: filters.search,
          });
  ...
  }, [fetchData, fetchStatistics, fetchPendingSyncCount, fetchNewItemsCount, activeTab]);
      ...
      case "new_items":
        return data.map((item: any) => (
          ...
          >
            ...
            <td className="px-4 py-3">
              <div className="font-medium text-gray-900">{item.de_no || "-"}</div>
            </td>
            <td className="px-4 py-3">
          ...
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              {[
                ...
                { key: "new_items", label: "New Items", icon: ClipboardDocumentListIcon },
