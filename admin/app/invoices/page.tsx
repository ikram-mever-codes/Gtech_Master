                      ...
                      <div key={invoice.id} className="p-4">
                        ...
                        <div className="flex gap-2">
                          {activeInvTab === "open_invoices" ? (
                            ...
                            <>
                              <button className="flex-1 py-2 bg-[#28A745] text-white text-[11px] font-bold rounded-[4px]">
                                Edit
                              </button>
                              <button className="flex-1 py-2 border border-[#6C757D] text-[#6C757D] text-[11px] font-bold rounded-[4px]">
                                Create PL
                              </button>
                              <button className="p-2 bg-[#F15A24] text-white rounded-[4px]">
