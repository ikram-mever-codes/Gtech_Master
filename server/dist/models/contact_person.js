...
__decorate([
    (0, typeorm_1.ManyToMany)(() => tags_1.Tag, (tag) => tag.contacts),
    (0, typeorm_1.JoinTable)({ name: "contact_tags" }),
    __metadata("design:type", Array)
], ContactPerson.prototype, "tags", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: "text", nullable: true }),
    __metadata("design:type", String)
], ContactPerson.prototype, "tagOrder", void 0);
