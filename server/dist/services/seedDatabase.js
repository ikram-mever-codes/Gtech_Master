...
const seedDatabase = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        //         }
        // 
        const existingPaymentMethods = yield paymentMethodRepository.count();
        if (existingPaymentMethods === 0) {
            ...
            for (const pm of paymentMethods) {
                yield paymentMethodRepository.save(paymentMethodRepository.create(pm));
            }
            console.log("  ✓ Seeded default payment methods");
        }
        const existingShippingMethods = yield shippingMethodRepository.count();
        if (existingShippingMethods === 0) {
            ...
            for (const sm of shippingMethods) {
                yield shippingMethodRepository.save(shippingMethodRepository.create(sm));
            }
