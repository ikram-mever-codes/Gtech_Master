...
const getAllSuppliers = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        queryBuilder.orderBy("supplier.id", "DESC")
            .skip(skip)
            .take(limit);
        const [suppliers, totalRecords] = yield Promise.all([
...
const createSupplier = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const supplierRepo = database_1.AppDataSource.getRepository(suppliers_1.Supplier);
        const _a = req.body, { id, created_at, updated_at, supplierItems, parents, supplier: _supplier, tags } = _a, supplierData = __rest(_a, ["id", "created_at", "updated_at", "supplierItems", "parents", "supplier", "tags"]);
...
const updateSupplier = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const _a = req.body, { id: _id, created_at, updated_at, supplierItems, parents, supplier: _supplier, tags } = _a, updateData = __rest(_a, ["id", "created_at", "updated_at", "supplierItems", "parents", "supplier", "tags"]);
