...
const createBusiness = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!finalCustomerNumber) {
            try {
                finalCustomerNumber =
                    yield number_sequence_service_1.NumberSequenceService.getNextNumber("customer");
            }
            catch (err) {
...
const updateBusiness = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { displayName, name, customerNumber, companyLabelPrintLogo, contactEmail, contactPhoneNumber, isDeviceMaker, isStarCustomer, starCustomerEmail, starBusinessDetails, street, addressAdditional, phone, vatTaxId, asanaLink, debtor_no, default_tax_profile_id, vat_id_status, defaultPaymentMethod, defaultShippingMethod, defaultPaymentDueDays, } = updateData;
        const user = req.user;
        const customerRepository = database_1.AppDataSource.getRepository(customers_1.Customer);
        const businessDetailsRepository = database_1.AppDataSource.getRepository(business_details_1.BusinessDetails);
        const starBusinessDetailsRepository = database_1.AppDataSource.getRepository(star_business_details_1.StarBusinessDetails);
...
const getAllBusinesses = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const businesses = customers.map((customer) => {
            ...
            const _t = customer.businessDetails || {}, { id: businessId } = _t, businessDetailsWithoutId = __rest(_t, ["id"]);
            return Object.assign(Object.assign({ id: customer.id, companyName: customer.companyName, displayName: customer.companyName, legalName: customer.legalName, name: customer.companyName, customerNumber: customer.customerNumber, companyLabelPrintLogo: customer.companyLabelPrintLogo, asanaLink: customer.asanaLink, email: customer.email, contactEmail: customer.contactEmail, contactPhoneNumber: customer.contactPhoneNumber, stage: customer.stage }, businessDetailsWithoutId), { address: (_a = customer.businessDetails) === null || _a === void 0 ? void 0 : _a.address, street: (_b = customer.businessDetails) === null || _b === void 0 ? void 0 : _b.address, addressAdditional: customer.addressLine2, city: (_c = customer.businessDetails) === null || _c === void 0 ? void 0 : _c.city, state: (_d = customer.businessDetails) === null || _d === void 0 ? void 0 : _d.state, country: (_e = customer.businessDetails) === null || _e === void 0 ? void 0 : _e.country, postalCode: (_f = customer.businessDetails) === null || _f === void 0 ? void 0 : _f.postalCode, website: (_g = customer.businessDetails) === null || _g === void 0 ? void 0 : _g.website, hasWebsite: !!((_h = customer.businessDetails) === null || _h === void 0 ? void 0 : _h.website), phoneNumber: (_j = customer.businessDetails) === null || _j === void 0 ? void 0 : _j.contactPhone, phone: (_k = customer.businessDetails) === null || _k === void 0 ? void 0 : _k.contactPhone, businessEmail: (_l = customer.businessDetails) === null || _l === void 0 ? void 0 : _l.email, note: (_m = customer.businessDetails) === null || _m === void 0 ? void 0 : _m.description, status: exports.BUSINESS_STATUS.ACTIVE, source: (_o = customer.businessDetails) === null || _o === void 0 ? void 0 : _o.businessSource, vatTaxId: customer.vatTaxId, deliveryAddressLine1: (_p = customer.starCustomerDetails) === null || _p === void 0 ? void 0 : _p.deliveryAddressLine1, deliveryPostalCode: (_q = customer.starCustomerDetails) === null || _q === void 0 ? void 0 : _q.deliveryPostalCode, deliveryCity: (_r = customer.starCustomerDetails) === null || _r === void 0 ? void 0 : _r.deliveryCity, deliveryCountry: (_s = customer.starCustomerDetails) === null || _s === void 0 ? void 0 : _s.deliveryCountry, debtor_no: customer.debtor_no, default_tax_profile_id: customer.default_tax_profile_id, vat_id_status: customer.vat_id_status, vat_id_checked_at: customer.vat_id_checked_at, vat_id_check_source: customer.vat_id_check_source, vat_id_check_response_json: customer.vat_id_check_response_json, defaultPaymentMethod: customer.defaultPaymentMethod, defaultShippingMethod: customer.defaultShippingMethod, defaultPaymentDueDays: customer.defaultPaymentDueDays, tags: customer.tags, tagOrder: customer.tagOrder, createdAt: customer.createdAt, updatedAt: customer.updatedAt });
        });
        return res.status(200).json({
            success: true,
            data: {
