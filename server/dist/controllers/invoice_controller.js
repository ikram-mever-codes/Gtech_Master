...
const calculateDueDate = (deliveryDate, dueDays) => {
    const base = typeof deliveryDate === "string" ? new Date(deliveryDate) : deliveryDate;
...
InvoiceController.createInvoice = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const dueDays = customer.defaultPaymentDueDays !== undefined &&
        ...
        const dueDate = invoiceData.deliveryDate
            ...
            : undefined;
        const invoice = invoiceRepository.create(Object.assign(Object.assign({}, invoiceData), { dueDate,
            customer }));
...
InvoiceController.generateInvoicePDF = (invoice) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        ...
        try {
            ...
            invoice.items.forEach((item, rowIndex) => {
                ...
                const rowData = [
                    ...
                    (() => {
                        ...
                        else if (((_b = item.item) === null || _b === void 0 ? void 0 : _b.transfer_price_EUR) !== undefined &&
                            ((_c = item.item) === null || _c === void 0 ? void 0 : _c.transfer_price_EUR) !== null)
            ...
            yPos += 15;
            const dueDays = ((_l = invoice.customer) === null || _l === void 0 ? void 0 : _l.defaultPaymentDueDays) !== undefined &&
                ((_m = invoice.customer) === null || _m === void 0 ? void 0 : _m.defaultPaymentDueDays) !== null
                ? invoice.customer.defaultPaymentDueDays
                : 7;
            const dueDateLabel = invoice.dueDate
                ? new Date(invoice.dueDate).toLocaleDateString("de-DE")
                : "";
            doc.text(dueDateLabel
                ? `Zahlungsziel: ${dueDays} Tage (fällig bis ${dueDateLabel})`
                : `Zahlungsziel: ${dueDays} Tage`, leftAlignX, yPos);
            if (invoice.notes) {
                yPos += 15;
        ...
        if (!fs_1.default.existsSync(filePath)) {
            ...
            try {
                ...
                return res.status(500).json({
                    message: "PDF file could not be found or regenerated. Please contact support.",
                });
            }
        }
...
InvoiceController.updateInvoice = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { id } = req.params;
        const _d = req.body, { items } = _d, invoiceData = __rest(_d, ["items"]);
        const invoice = yield invoiceRepository.findOne({
            where: { id },
        ...
        if (invoiceData.deliveryDate) {
            const dueDays = ((_b = invoice.customer) === null || _b === void 0 ? void 0 : _b.defaultPaymentDueDays) !== undefined &&
                ((_c = invoice.customer) === null || _c === void 0 ? void 0 : _c.defaultPaymentDueDays) !== null
                ? invoice.customer.defaultPaymentDueDays
                : 7;
            invoiceData.dueDate = calculateDueDate(invoiceData.deliveryDate, dueDays);
        }
        if (invoiceData.description !== undefined &&
            !invoiceData.description.trim()) {
            return res.status(400).json({ message: "Description is required" });
        }
        if (invoiceData.freightCost !== undefined &&
    ...
    try {
        ...
        if (allCargoIds.length > 0) {
            ...
            allCargoOrders.forEach((co) => {
                var _b, _c;
                if (((_b = co.cargo) === null || _b === void 0 ? void 0 : _b.cargo_no) &&
                    ((_c = co.order) === null || _c === void 0 ? void 0 : _c.comment) &&
      ...
      `);
        ...
        const data = invoices
            ...
            const cargoNo = (cargo === null || cargo === void 0 ? void 0 : cargo.cargo_no) ||
            ...
            const rawShipTo = typeof (cargo === null || cargo === void 0 ? void 0 : cargo.ship_to_company_name) === "string" &&
                cargo.ship_to_company_name.trim().length > 1
                ? cargo.ship_to_company_name.trim()
                : typeof (cargo === null || cargo === void 0 ? void 0 : cargo.ship_to_display_name) === "string" &&
                    cargo.ship_to_display_name.trim().length > 1
                    ? cargo.ship_to_display_name.trim()
                    : typeof ((_b = inv.customer) === null || _b === void 0 ? void 0 : _b.companyName) === "string" &&
...
InvoiceController.getInvoiceExpandedDetails = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const getGroupKey = (oi) => {
            var _b, _c, _d, _e, _f;
            const itemTaricCode = ((_c = (_b = oi.item) === null || _b === void 0 ? void 0 : _b.taric) === null || _c === void 0 ? void 0 : _c.code) || "";
            const isProjectItem = !itemTaricCode ||
                itemTaricCode === "0" ||
        ...
        const manualTarics = uniqueManualCodes.length > 0
            ? yield database_1.AppDataSource.getRepository(tarics_1.Taric).find({
                where: { code: (0, typeorm_1.In)(uniqueManualCodes) },
            })
            : [];
        ...
        orderItems.forEach((oi) => {
            ...
            if (!taricGroupsMap.has(groupKey)) {
                ...
                let unitPrice = (oi === null || oi === void 0 ? void 0 : oi.eur_special_price) ||
                    (oi === null || oi === void 0 ? void 0 : oi.price) ||
                    (item === null || item === void 0 ? void 0 : item.transfer_price_EUR) ||
            ...
            let currentPrice = (oi === null || oi === void 0 ? void 0 : oi.eur_special_price) ||
                (oi === null || oi === void 0 ? void 0 : oi.price) ||
                (item === null || item === void 0 ? void 0 : item.transfer_price_EUR) ||
                (item === null || item === void 0 ? void 0 : item.price) ||
                0;
        ...
        const itemsWithFallbacks = yield Promise.all([...orderItems].map((oi) => __awaiter(void 0, void 0, void 0, function* () {
            const item = oi.item;
            ...
            let eurPrice = oi.eur_special_price ||
                oi.price ||
                (item === null || item === void 0 ? void 0 : item.transfer_price_EUR) ||
                (item === null || item === void 0 ? void 0 : item.price) ||
                0;
        ...
        const orderNosInCargo = [
            ...new Set(orderItems.map((oi) => { var _b; return (_b = oi.order) === null || _b === void 0 ? void 0 : _b.order_no; }).filter(Boolean)),
        ];
        return res.json({
            success: true,
            data: {
    ...
    try {
        ...
        if (invoice.packingListData &&
            ...
            if (!orderComment && orderItems.length > 0) {
                orderComment =
                    ((_c = (_b = orderItems.find((oi) => { var _b; return (_b = oi.order) === null || _b === void 0 ? void 0 : _b.comment; })) === null || _b === void 0 ? void 0 : _b.order) === null || _c === void 0 ? void 0 : _c.comment) ||
                        "";
                if (!orderComment) {
                    ...
                    if (distinctOrderIds.length > 0) {
                        const relatedOrders = yield orderRepository.find({
                            where: { id: (0, typeorm_1.In)(distinctOrderIds) },
                        });
                        orderComment =
                            ((_d = relatedOrders.find((o) => o.comment)) === null || _d === void 0 ? void 0 : _d.comment) || "";
                    }
                }
            }
        ...
        const formatGermanDate = (dateVal) => {
            if (!dateVal)
                return "";
        ...
        doc
            .fontSize(8)
            .font("Helvetica")
            .text("Yongxin Road, Bowang Town, Bowang, Maanshan, Anhui, China", 30, 54, { align: "center", width: 535 });
        ...
        doc
            .fontSize(8)
            .text("Antonio-Segni-Str. 4 44263 Dortmund Germany, Tel: +4923158697565", 35, 119);
        ...
        doc
            .moveTo(colX.measure + colWidths.measure / 3, itemY)
            .lineTo(colX.measure + colWidths.measure / 3, itemY + totalsRowHeight + 15)
            .stroke();
        doc
            .moveTo(colX.measure + (colWidths.measure / 3) * 2, itemY)
            .lineTo(colX.measure + (colWidths.measure / 3) * 2, itemY + totalsRowHeight + 15)
            .stroke();
        doc
            .moveTo(colX.volume, itemY)
        ...
        const uniquePackages = [
            ...new Set(items.map((i) => i.package).filter(Boolean)),
        ];
...
InvoiceController.markAsPaid = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!invoice.invoiceNumber || !invoice.invoiceNumber.startsWith("CI")) {
            let generatedNo = "";
            try {
                generatedNo = yield number_sequence_service_1.NumberSequenceService.getNextNumber("closed_ci");
            }
            catch (err) {
