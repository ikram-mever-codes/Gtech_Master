...
const getAllContactPersons = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { page = 1, limit = 30, search, businessName, starBusinessDetailsId, position, sex, stateLinkedIn, contact, hasEmail, hasPhone, hasLinkedIn, sortBy = "createdAt", sortOrder = "DESC", tags, } = req.query;
        const customerRepository = database_1.AppDataSource.getRepository(customers_1.Customer);
        ...
        if (tags) {
            ...
            if (includeTagIds.length > 0) {
                allContactPersons = allContactPersons.filter((contactPerson) => {
                    var _a;
                    const contactTagIds = ((_a = contactPerson.tags) === null || _a === void 0 ? void 0 : _a.map((t) => t.id)) || [];
