...
const bulkImportContactPersons = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (contactPersonsToSave.length > 0) {
            try {
                const savedContactPersons = yield contactPersonRepository.save(contactPersonsToSave, { chunk: 100 } // Save in chunks of 100
                );
...
const getAllStarBusinesses = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const formattedRecords = yield Promise.all(starRecords.map((record) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const baseData = {
                id: (_a = record.starBusinessDetails) === null || _a === void 0 ? void 0 : _a.id,
                ...
                website: (_b = record.businessDetails) === null || _b === void 0 ? void 0 : _b.website,
                city: (_c = record.businessDetails) === null || _c === void 0 ? void 0 : _c.city,
                country: (_d = record.businessDetails) === null || _d === void 0 ? void 0 : _d.country,
                address: (_e = record.businessDetails) === null || _e === void 0 ? void 0 : _e.address,
                postalCode: (_f = record.businessDetails) === null || _f === void 0 ? void 0 : _f.postalCode,
                industry: ((_g = record.starBusinessDetails) === null || _g === void 0 ? void 0 : _g.industry) ||
                    ((_h = record.businessDetails) === null || _h === void 0 ? void 0 : _h.industry),
                inSeries: (_j = record.starBusinessDetails) === null || _j === void 0 ? void 0 : _j.inSeries,
                madeIn: (_k = record.starBusinessDetails) === null || _k === void 0 ? void 0 : _k.madeIn,
                device: (_l = record.starBusinessDetails) === null || _l === void 0 ? void 0 : _l.device,
                lastChecked: (_m = record.starBusinessDetails) === null || _m === void 0 ? void 0 : _m.lastChecked,
                checkedBy: (_o = record.starBusinessDetails) === null || _o === void 0 ? void 0 : _o.checkedBy,
                comment: (_p = record.starBusinessDetails) === null || _p === void 0 ? void 0 : _p.comment,
                stage: record.stage,
                createdAt: record.createdAt,
                updatedAt: record.updatedAt,
            };
            if (includeContactsCount &&
                ((_q = record.starBusinessDetails) === null || _q === void 0 ? void 0 : _q.id) &&
