...
const createList = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const createdBy = yield createCreator(userId || null, customerId);
...
const searchItems = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            ...
            return next(new errorHandler_1.default("Failed to search items in database", 500));
        }
    }
    catch (error) {
...
const getAllLists = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const listsWithChanges = lists.map((list) => {
            var _a, _b;
            return (Object.assign(Object.assign({}, list), { pendingChangesCount: list.getPendingFieldChanges().length, hasPendingChanges: list.hasPendingChanges(), refreshStats: shouldRefresh
                    ? {
