...
class InquiryController {
    ...
    getNextInquiryNo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const allInquiries = yield this.inquiryRepository
    ...
    getAllInquiries(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { page = 1, limit = 10, customerId, status, priority, contactPersonId, isAssembly, tags, } = request.query;
                ...
                const filteredData = (0, dataFilter_1.filterDataByRole)(inquiries, (user === null || user === void 0 ? void 0 : user.role) || users_1.UserRole.STAFF);
    ...
    getInquiryById(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = request.user;
                const filteredData = (0, dataFilter_1.filterDataByRole)(inquiry, (user === null || user === void 0 ? void 0 : user.role) || users_1.UserRole.STAFF);
                return response.status(200).json({
                    success: true,
                    data: filteredData,
                });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (requests && Array.isArray(requests) && requests.length > 0) {
                    ...
                    let defaultProCatId = undefined;
                    try {
                        const categoryRepository = database_1.AppDataSource.getRepository(categories_1.Category);
                        const proCat = yield categoryRepository.findOne({ where: { name: "PRO" } });
                        if (proCat) {
                    ...
                    const requestEntities = requests.map((reqData, index) => {
                        ...
                        const requestItem = this.requestRepository.create(Object.assign(Object.assign({}, reqDataWithoutId), { itemNo: reqData.itemNo || String(index + 1).padStart(3, "0"), cat_id: reqData.cat_id || defaultProCatId, businessId: starBusinessDetails.id, business: starBusinessDetails, inquiry: savedInquiry, qty: currentQty, totalWeight: totalWeight || reqData.totalWeight, targetPrice: reqData.targetPrice || null, annualPotential: annualPotential, annualPotentialKEur: annualPotentialKEur }));
                        return requestItem;
                    });
                    ...
                    if (requests.length > 0) {
                        ...
                        if (starBusinessDetails) {
                            ...
                            const requestEntities = requests.map((reqData, index) => {
                                ...
                                const annualPotentialKEur = annualPotential / 1000;
                                total_potential_k_eur += annualPotentialKEur;
                                const requestItem = this.requestRepository.create(Object.assign(Object.assign({}, reqDataWithoutId), { itemNo: reqData.itemNo || String(index + 1).padStart(3, "0"), cat_id: reqData.cat_id || defaultProCatId, businessId: starBusinessDetails.id, business: starBusinessDetails, inquiry: existingInquiry, qty: currentQty, totalWeight: totalWeight || reqData.totalWeight, targetPrice: reqData.targetPrice || null, annualPotential: annualPotential, annualPotentialKEur: annualPotentialKEur }));
                                return requestItem;
                            });
                            yield this.requestRepository.save(requestEntities);
                        }
