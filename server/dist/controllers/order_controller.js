...
const createOrder = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { category_id, customer_id, supplier_id, status, comment, items, source_offer_id } = req.body;
...
const generateLabelPDF = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.log("[label] logo decision:", {
            ...
            itemCustomerId: (_a = resolvedItem === null || resolvedItem === void 0 ? void 0 : resolvedItem.customer_id) !== null && _a !== void 0 ? _a : null,
            orderCustomerId: (_c = (_b = order === null || order === void 0 ? void 0 : order.customer) === null || _b === void 0 ? void 0 : _b.id) !== null && _c !== void 0 ? _c : null,
            brandingCustomerId: (_d = brandingCustomer === null || brandingCustomer === void 0 ? void 0 : brandingCustomer.id) !== null && _d !== void 0 ? _d : null,
        ...
        const barcodeValue = (((_e = resolvedItem === null || resolvedItem === void 0 ? void 0 : resolvedItem.ean) === null || _e === void 0 ? void 0 : _e.toString()) ||
            ((_f = warehouseItem === null || warehouseItem === void 0 ? void 0 : warehouseItem.ean) === null || _f === void 0 ? void 0 : _f.toString()) ||
            "").trim();
...
const generateCommercialInvoicePDF = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const customerNo = (() => {
            var _a;
            if (customer === null || customer === void 0 ? void 0 : customer.customerNumber)
        ...
        const isClosedInvoice = invoice.status === "closed" ||
            invoice.status === "Closed" ||
            invoice.isClosed;
        const invoiceNoVal = (invoice.invoiceNumber || "").replace(/-/g, "").trim();
        const formattedDateVal = formatGermanDate(invoice.invoiceDate);
        const cargoNoVal = ((cargo === null || cargo === void 0 ? void 0 : cargo.cargo_no) || invoice.orderNumber || "").trim();
        const data = {
        ...
        if (bEori) {
            doc.font("Helvetica-Bold").text(`EORI: ${bEori}`, 40, billY, { width: 155 });
        }
