...
const getAllOrders = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const orders = yield qb.orderBy("o.id", "DESC").addOrderBy("items.id", "ASC").getMany();
        const mappedOrders = orders.map((order) => (Object.assign(Object.assign({}, order), { items: order.orderItems || [], orderItems: undefined })));
        return res.status(200).json({
            success: true,
            data: mappedOrders,
        });
