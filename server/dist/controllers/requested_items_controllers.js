...
class RequestedItemController {
    ...
    getAllRequestedItems(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { page = 1, limit = 10, businessId, status, priority, contactPersonId, inquiryId, minWeight, maxWeight, tags, } = request.query;
                    ...
                    if (includeTagIds.length > 0) {
                        queryBuilder.andWhere((qb) => {
                            const subQuery = qb
                                .subQuery()
                                .select("c.id")
                                .from(requested_items_1.RequestedItem, "c")
                                .innerJoin("c.tags", "t")
                ...
                const filteredData = (0, dataFilter_1.filterDataByRole)(enrichedItems, (user === null || user === void 0 ? void 0 : user.role) || users_1.UserRole.STAFF);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const enrichedItem = Object.assign(Object.assign({}, item), { business: Object.assign(Object.assign({}, item.business), { customer: customer
                            ...
                            : null }) });
                const user = request.user;
                const filteredData = (0, dataFilter_1.filterDataByRole)(enrichedItem, (user === null || user === void 0 ? void 0 : user.role) || users_1.UserRole.STAFF);
                return response.status(200).json({
                    success: true,
                    data: filteredData,
                });
