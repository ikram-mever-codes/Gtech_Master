...
const requestCustomerAccount = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { companyName, legalName, email, contactEmail, contactPhoneNumber, taxNumber, vatTaxId, deliveryAddressLine1, deliveryAddressLine2, deliveryPostalCode, deliveryCity, deliveryCountry, password, } = req.body;
        ...
        const duplicateConditions = [{ companyName }];
        if (email)
            duplicateConditions.push({ email });
        if (contactEmail)
            duplicateConditions.push({ contactEmail });
        if (contactPhoneNumber)
            duplicateConditions.push({ contactPhoneNumber });
...
const editCustomerProfile = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { companyName, legalName, contactEmail, contactPhoneNumber, taxNumber, vatTaxId, deliveryAddressLine1, deliveryAddressLine2, deliveryPostalCode, deliveryCity, deliveryCountry, } = req.body;
        const customerRepository = database_1.AppDataSource.getRepository(customers_1.Customer);
        const starCustomerDetailsRepository = database_1.AppDataSource.getRepository(star_customer_details_1.StarCustomerDetails);
        const customer = yield customerRepository.findOne({
            where: { id: customerId },
    ...
    try {
        ...
        const customersData = customers.map((customer) => {
            ...
            return ({
                ...
                vatTaxId: customer === null || customer === void 0 ? void 0 : customer.vatTaxId,
