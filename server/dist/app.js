...
const number_sequence_routes_1 = __importDefault(require("./routes/number_sequence_routes"));
const payment_method_routes_1 = __importDefault(require("./routes/payment_method_routes"));
const shipping_method_routes_1 = __importDefault(require("./routes/shipping_method_routes"));
...
app.use("/api/v1/number-sequences", number_sequence_routes_1.default);
...
app.use("/api/v1/shipping-methods", shipping_method_routes_1.default);
