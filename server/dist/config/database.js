...
exports.AppDataSource = new typeorm_1.DataSource({
    ...
    entities: [
        ...
        payment_methods_1.PaymentMethod,
        shipping_methods_1.ShippingMethod,
        number_sequence_1.NumberSequence,
    ],
    extra: {
...
const bootstrapAdminUser = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (existingUser) {
            ...
            const isPasswordMatch = (0, bcryptjs_1.compareSync)(password, existingUser.password);
            if (!isPasswordMatch) {
                existingUser.password = (0, bcryptjs_1.hashSync)(password, 10);
                yield userRepository.save(existingUser);
            }
        }
        else {
...
const initializeDatabase = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield NumberSequenceService.seedDefaultSequences();
